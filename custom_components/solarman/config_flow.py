...
from homeassistant.helpers.selector import SelectSelector, SelectSelectorConfig, StringSelector, StringSelectorConfig
...
CONFIGURATION_SCHEMA = {
    ...
    vol.Optional(CONF_USERNAME, default = DEFAULT_[CONF_USERNAME], description = {SUGGESTED_VALUE: DEFAULT_[CONF_USERNAME]}): StringSelector(StringSelectorConfig()),
    vol.Optional(CONF_PASSWORD, default = DEFAULT_[CONF_PASSWORD], description = {SUGGESTED_VALUE: DEFAULT_[CONF_PASSWORD]}): StringSelector(StringSelectorConfig(type = "password")),
